...
namespace SalesWebMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s2 = new Seller(2, "Maria Green", "maria@gmail.com", 2100.0, new DateTime(1979, 12, 31), d2);
            Seller s3 = new Seller(3, "Alex Grey", "alex1@gmail.com", 1800.00, new DateTime(1988, 1, 15), d1);
            Seller s4 = new Seller(4, "Martha Red", "martha@gmail.com", 1500.00, new DateTime(1985, 11, 1), d4);
            Seller s5 = new Seller(5, "Donald Blue", "donald@gmail.com", 2000.0, new DateTime(1992, 7, 3), d3);
            Seller s6 = new Seller(6, "Alex Pink", "alex2@gmail.com", 3000.0, new DateTime(2000, 2, 6), d2);
